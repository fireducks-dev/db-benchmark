...
print("# groupby-fireducks.py", flush=True)
...
gc.collect()
t_start = timeit.default_timer()
ans = x[['id2','id4','v1']].groupby(['id2','id4'], as_index=False, sort=False, observed=True, dropna=False)[['v1']].corrwith(x['v2']).assign(r2=lambda x: x['v1'] * x['v1'])[['id2', 'id4', 'r2']]
print(ans.shape, flush=True)
t = timeit.default_timer() - t_start
m = memory_usage()
t_start = timeit.default_timer()
